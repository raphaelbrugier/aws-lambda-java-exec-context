...
This is a sample template for lambda-java-eval - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name lambda-java-eval --query 'Stacks[].Outputs'
```
